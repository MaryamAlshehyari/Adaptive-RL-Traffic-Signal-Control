...
if __name__ == "__main__":
    ...
    prs.add_argument("-t", type=str, default="ppo_hangzhou", help="Plot title\n")
    prs.add_argument("-yaxis", type=str, default="system_total_arrived", help="The column to plot.\n")
    ...
    prs.add_argument("-ylabel", type=str, default="system_total_arrived", help="Y axis label.\n")
    prs.add_argument("-output", type=str, default=None, help="PDF output filename.\n")
    prs.add_argument("-xmax", type=int, default=None, help="Maximum x-axis limit.\n")
    ...
    # plt.xlim(0, 1250)  # Only show time steps from 0 to 5000 seconds
    # plt.ylim(0, 1080)    # Optional: adjust y-axis if needed

    plt.savefig("output_plot_dqn_hangzhou_arrived.png")
